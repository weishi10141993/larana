...
class dune::MCTruthT0Matching : public art::EDProducer {
public:
...
dune::MCTruthT0Matching::MCTruthT0Matching(fhicl::ParameterSet const & p)
// :
...
void dune::MCTruthT0Matching::reconfigure(fhicl::ParameterSet const & p)
{
...
void dune::MCTruthT0Matching::beginJob()
{
  // Implementation of optional member function here.
...
void dune::MCTruthT0Matching::produce(art::Event & evt)
{
...
DEFINE_ART_MODULE(dune::MCTruthT0Matching)
