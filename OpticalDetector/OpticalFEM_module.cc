...
namespace opdet {
  ...
  private:  
    ...
    timeVector_t         fm_beamDelay;          // number of time slices to include prior to start of beam gate
...
namespace opdet {
  ...
  void OpticalFEM::reconfigure(fhicl::ParameterSet const& p)
  {
    ...
    fm_beamDelay          = p.get< timeVector_t >        ("BeamDelay");
