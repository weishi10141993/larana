...
namespace t0 {
  ...
  MCParticleHitMatching::MCParticleHitMatching(fhicl::ParameterSet const& pset) : EDProducer{pset}
  {
    ...
    // Get the tool for MC Truth matching
    fHitParticleAssociations = art::make_tool<IHitParticleAssociations>(
      pset.get<fhicl::ParameterSet>("HitParticleAssociations"));
